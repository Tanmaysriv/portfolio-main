...
export const ThemeToggleButton = ({ className = "", variant = "circle", start = "center", blur = false, gifUrl = "", }) => {
    ...
    return (_jsxs(Button, { type: "button", variant: "ghost", size: "icon", className: cn("size-10 cursor-pointer p-0 transition-all duration-300 active:scale-95 border border-white/10", className), onClick: toggleTheme, "aria-label": "Toggle theme", children: [_jsx("span", { className: "sr-only", children: "Toggle theme" }), isDark ? _jsx(Moon, { className: "size-4" }) : _jsx(Sun, { className: "size-4" })] }));
};
