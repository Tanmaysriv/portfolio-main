...
export function getMDXComponents(components) {
    return {
        ...
        Step,
        Sponsor,
        AutoTypeTable: (props) => (_jsx(AutoTypeTable, { ...props, generator: generator })),
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        pre: ({ ref: _ref, ...props }) => (_jsx(CodeBlock, { ...props, children: _jsx(Pre, { children: props.children }) })),
        img: (props) => _jsx(ImageZoom, { ...props }),
        strong: (props) => _jsx(Bold, { ...props }),
        b: (props) => _jsx(Bold, { ...props }),
        ...components,
    };
}
